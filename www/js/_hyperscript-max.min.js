(()=>{var Ji=Object.defineProperty;var N=(s,e)=>{for(var t in e)Ji(s,t,{get:e[t],enumerable:!0})};var xe=class{#t;#i=[];#s=null;#o=[];source;constructor(e,t){this.#t=e,this.source=t,this.consumeWhitespace()}get list(){return this.#t}get consumed(){return this.#i}toString(){var e=this.currentToken(),t=this.source.split(`
...
<div class="hdb" _="
	...
	* {
	...
	`;H.prototype.ui=function(){var s=document.createElement("div"),e=s.attachShadow({mode:"open"});s.style.cssText="all: initial",e.innerHTML=xn,document.body.appendChild(s),this._hyperscript.process(e.querySelector(".hdb"))};function Di(s){s.addCommand(Z.keyword,Z.parse.bind(Z))}typeof self<"u"&&self._hyperscript&&self._hyperscript.use(Di);function ji(s){let{runtime:e,createParser:t,reactivity:r}=s.internals,i=new M;function n(h,d,f){if(!d)return h;var v=document.createElement("div");v.innerHTML=d;var m={},p=[];for(var y of Array.from(v.childNodes)){y.nodeType===1&&f&&!y.hasAttribute("dom-scope")&&y.setAttribute("dom-scope","parent of "+f);var g=y.nodeType===1&&y.getAttribute("slot");g?(y.removeAttribute("slot"),m[g]||(m[g]=""),m[g]+=y.outerHTML):p.push(y.nodeType===1?y.outerHTML:y.nodeType===3?y.textContent:"")}var k=p.join(""),x=h.replace(/<slot\s+name\s*=\s*["']([^"']+)["']\s*\/?\s*>(\s*<\/slot>)?/g,function(w,b){return m[b]||""});return x=x.replace(/<slot\s*\/?\s*>(\s*<\/slot>)?/g,k),x}function o(h,d){if(typeof d!="string")return null;var f=h._attrsCache||(h._attrsCache={});if(!f[d]){var v=h.getAttribute(d);if(v==null)return null;try{f[d]=t(i.tokenize(v)).requireElement("expression")}catch(m){return console.error("component: failed to parse attrs."+d+":",m.message),null}}return f[d]}function a(h){var d=h.parentElement;return d?e.makeContext(d,null,d,null):null}function l(h){return new Proxy({_hsSkipTracking:!0},{get:function(d,f){if(f==="_hsSkipTracking")return!0;if(!(typeof f!="string"||f.startsWith("_"))){var v=o(h,f);if(v){var m=a(h);return m?v.evaluate(m):void 0}}},set:function(d,f,v){var m=o(h,f);if(!m||!m.set)return!1;var p=a(h);if(!p)return!1;var y={};if(m.lhs)for(var g in m.lhs){var k=m.lhs[g];y[g]=k&&k.evaluate?k.evaluate(p):k}return m.set(p,y,v),!0}})}function u(h,d){let f=h.getAttribute("component");if(!f.includes("-")){console.error("component name must contain a dash: '"+f+"'");return}for(var v=h.textContent,m="",p=/<style[^>]*>([\s\S]*?)<\/style>/gi,y;(y=p.exec(v))!==null;)m+=y[1]+`
`;if(m&&(v=v.replace(/<style[^>]*>[\s\S]*?<\/style>/gi,""),h.textContent=v),m){var g=document.createElement("style");g.textContent="@scope ("+f+`) {
`+m+"}",h.insertAdjacentElement("afterend",g)}let k=h.textContent,x=class extends HTMLElement{connectedCallback(){if(this._hypercomp_initialized)return;this._hypercomp_initialized=!0,this.setAttribute("dom-scope","isolated"),this._slotContent=this.innerHTML,this.innerHTML="";var w=e.getInternalData(this);w.elementScope||(w.elementScope={}),w.elementScope.attrs=l(this),d&&(this.setAttribute("_",d),s.process(this));let b=this;var L=n(k,b._slotContent,f);queueMicrotask(function(){var A=b._renderTemplate(L);A&&A.then?A.then(function(I){b._stampTemplate(I),b._setupReactiveEffect(L)}):(b._stampTemplate(A),b._setupReactiveEffect(L))})}disconnectedCallback(){r.stopElementEffects(this),e.cleanup(this),this._hypercomp_initialized=!1,this._hypercomp_stamped=!1}_setupReactiveEffect(w){var b=this;r.createEffect(function(){return b._renderTemplate(w)},function(L){b._stampTemplate(L)},{element:b})}_renderTemplate(w){var b=e.makeContext(this,null,this,null),L=[];b.meta.__ht_template_result=L;var A=i.tokenize(w,"lines"),I=t(A),j;try{j=I.parseElement("commandList"),I.ensureTerminated(j)}catch(U){return console.error("hypercomp template parse error:",U.message||U),""}var ie,ne,G=new Promise(function(U,we){ie=U,ne=we});return j.execute(b),this.__hs_scopes=b.meta.__ht_scopes||null,b.meta.returned||!b.meta.resolve?L.join(""):(b.meta.resolve=ie,b.meta.reject=ne,G.then(function(){return L.join("")}))}_stampTemplate(w){this._hypercomp_stamped?e.morph(this,w):(this.innerHTML=w,s.process(this),this._hypercomp_stamped=!0)}};customElements.define(f,x)}var c=new Set;s.addBeforeProcessHook(function(h){!h||!h.querySelectorAll||h.querySelectorAll('script[type="text/hyperscript-template"][component]').forEach(function(d){d._componentScript==null&&(d._componentScript=d.getAttribute("_")||"",d.removeAttribute("_"))})}),s.addAfterProcessHook(function(h){!h||!h.querySelectorAll||h.querySelectorAll('script[type="text/hyperscript-template"][component]').forEach(function(d){var f=d.getAttribute("component");!c.has(f)&&!customElements.get(f)&&(c.add(f),u(d,d._componentScript||""))})})}typeof self<"u"&&self._hyperscript&&self._hyperscript.use(ji);function Sn(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(s){var e=Math.random()*16|0,t=s=="x"?e:e&3|8;return t.toString(16)})}function Wi(s){var e=s;if(e.startsWith("/")){var t=window.location.hostname+(window.location.port?":"+window.location.port:"");window.location.protocol==="https:"?e="wss://"+t+e:window.location.protocol==="http:"&&(e="ws://"+t+e)}return e}var qn=["then","catch","length","toJSON"],V=class s extends q{static keyword="socket";constructor(e,t,r,i){super(),this.socketName=e,this.nameSpace=t,this.socketObject=r,this.messageHandler=i}install(e,t,r,i){this.runtime=i,i.assignToNamespace(e,this.nameSpace,this.socketName,this.socketObject)}static parse(e){if(!e.matchToken("socket"))return;var t=e.requireElement("dotOrColonPath"),r=t.evalStatically(),i=r.split("."),n=i.pop(),o={},a=e.parseURLOrExpression(),l=1e4;e.matchToken("with")&&(e.requireToken("timeout"),l=e.requireElement("expression").evalStatically());var u=!1,c=null;e.matchToken("on")&&(e.requireToken("message"),e.matchToken("as")&&(e.matchToken("JSON")||e.requireToken("json"),u=!0),c=e.requireElement("commandList"),e.ensureTerminated(c));var h=new WebSocket(Wi(a.evalStatically()));function d(p){return new Proxy({},{get:function(y,g){return qn.includes(g)?null:g==="noTimeout"?d(-1):g==="timeout"?function(k){return d(parseInt(k))}:function(){for(var k=Sn(),x=[],w=0;w<arguments.length;w++)x.push(arguments[w]);var b={iid:k,function:g,args:x};h=h||new WebSocket(Wi(a.evalStatically())),h.send(JSON.stringify(b));var L=new Promise(function(A,I){o[k]={resolve:A,reject:I}});return p>=0&&setTimeout(function(){o[k]&&o[k].reject("Timed out"),delete o[k]},p),L}}})}var f=d(l),v={raw:h,dispatchEvent:function(p){var y=p.detail;delete y.sender,delete y._namedArgList_,h.send(JSON.stringify(Object.assign({type:p.type},y)))},rpc:f},m=new s(n,i,v,c);return h.onmessage=function(p){var y=p.data;try{var g=JSON.parse(y)}catch{}if(g&&g.iid&&(g.throw?o[g.iid].reject(g.throw):o[g.iid].resolve(g.return),delete o[g.iid]),c){var k=m.runtime.makeContext(v,m,v);if(u)if(g)k.locals.message=g,k.result=g;else throw new Error("Received non-JSON message from socket: "+y);else k.locals.message=y,k.result=y;c.execute(k)}},h.addEventListener("close",function(p){h=null}),c&&e.setParent(c,m),m}};function Ui(s){s.addFeature(V.keyword,V.parse.bind(V))}typeof self<"u"&&self._hyperscript&&self._hyperscript.use(Ui);var Nn=0,An=function(s){s.onmessage=function(e){switch(e.data.type){case"init":s.importScripts(e.data._hyperscript),s.importScripts.apply(s,e.data.extraScripts);var t=s._hyperscript.parse(e.data.src);t.apply(s,s),postMessage({type:"didInit"});break;case"call":try{var r=s._hyperscript.internals.runtime.getHyperscriptFeatures(s)[e.data.function].apply(s,e.data.args);Promise.resolve(r).then(function(n){postMessage({type:"resolve",id:e.data.id,value:n})}).catch(function(n){postMessage({type:"reject",id:e.data.id,error:n.toString()})})}catch(n){postMessage({type:"reject",id:e.data.id,error:n.toString()})}break}}},Ln="("+An.toString()+")(self)",On=new Blob([Ln],{type:"text/javascript"}),In=URL.createObjectURL(On),ee=class s extends q{static keyword="worker";constructor(e,t,r,i){super(),this.workerName=e,this.name=e,this.nameSpace=t,this.worker=r,this.stubs=i}static parse(e){if(e.matchToken("worker")){var t=e.requireElement("dotOrColonPath"),r=t.evalStatically(),i=r.split("."),n=i.pop(),o=[];if(e.matchOpToken("(")&&!e.matchOpToken(")")){do{var a=e.requireTokenType("STRING").value,l=new URL(a,location.href).href;o.push(l)}while(e.matchOpToken(","));e.requireOpToken(")")}var u=[],c=e.consumed.length,h=e.consumed.length;do{var d=e.parseAnyOf(["defFeature","jsFeature"]);if(d){if(d.type==="defFeature")u.push(d.name),h=e.consumed.length;else if(e.hasMore())continue}else break}while(e.matchToken("end")&&e.hasMore());var f=e.consumed.slice(c,h+1),v=e.source.substring(f[0].start,f[f.length-1].end),m=new Worker(In);m.postMessage({type:"init",_hyperscript:document.currentScript?.src||"/dist/_hyperscript.js",extraScripts:o,src:v});var p=new Promise(function(g,k){m.addEventListener("message",function(x){x.data.type==="didInit"&&g()},{once:!0})}),y={};return u.forEach(function(g){y[g]=function(){var k=arguments;return new Promise(function(x,w){var b=Nn++;m.addEventListener("message",function L(A){A.data.id===b&&(m.removeEventListener("message",L),A.data.type==="resolve"?x(A.data.value):w(A.data.error))}),p.then(function(){m.postMessage({type:"call",function:g,args:Array.from(k),id:b})})})}}),new s(n,i,m,y)}}install(e,t,r,i){i.assignToNamespace(e,this.nameSpace,this.workerName,this.stubs)}};function Bi(s){s.addFeature(ee.keyword,ee.parse.bind(ee))}typeof self<"u"&&self._hyperscript&&self._hyperscript.use(Bi);async function*zi(s){var e=new TextDecoder,t="",r=!1,i={data:"",event:"",id:"",retry:null},n=!0;try{for(;;){var{done:o,value:a}=await s.read();if(o)break;var l=e.decode(a,{stream:!0});n&&(l.charCodeAt(0)===65279&&(l=l.slice(1)),n=!1),t+=l;var u=t.split(/\r\n|\r|\n/);t=u.pop()||"";for(var c=0;c<u.length;c++){var h=u[c];if(!h){r&&(yield i,r=!1,i={data:"",event:"",id:"",retry:null});continue}var d=h.indexOf(":");if(d!==0){var f,v;if(d<0?(f=h,v=""):(f=h.slice(0,d),v=h.slice(d+1),v[0]===" "&&(v=v.slice(1))),f==="data")i.data+=(r?`
`:"")+v,r=!0;else if(f==="event")i.event=v;else if(f==="id")v.includes("\0")||(i.id=v);else if(f==="retry"){var m=parseInt(v,10);isNaN(m)||(i.retry=m)}}}}}finally{s.releaseLock()}}function Mn(s,e){if(s===e)return!0;if(!s.includes("*"))return!1;var t=new RegExp("^"+s.replace(/[.+^${}()|[\]\\]/g,"\\$&").replace(/\*/g,".*")+"$");return t.test(e)}var te=class s extends q{static keyword="eventsource";constructor(e,t,r){super(),this.eventSourceName=e,this.nameSpace=t,this.stub=r}install(e,t,r,i){this.runtime=i,i.assignToNamespace(e,this.nameSpace,this.eventSourceName,this.stub)}static parse(e){if(e.matchToken("eventsource")){var t,r=!1,i="GET",n=null,o=e.requireElement("dotOrColonPath"),a=o.evalStatically(),l=a.split("."),u=l.pop();for(e.matchToken("from")&&(t=e.parseURLOrExpression());e.matchToken("with");)e.matchToken("credentials")?r=!0:e.matchToken("method")?i=e.requireElement("stringLike").evalStatically().toUpperCase():e.matchToken("headers")?n=e.requireElement("objectLiteral"):e.raiseExpected("credentials","method","headers");var c=null;if(n){c={};for(var h=0;h<n.keyExpressions.length;h++){var d=n.keyExpressions[h].evalStatically(),f=n.valueExpressions[h].evalStatically();c[d]=f}}for(var v=Cn(r,i,c),m=new s(u,l,v);e.matchToken("on");){var p=e.requireElement("stringLike").evalStatically(),y="";e.matchToken("as")&&(y=e.requireElement("stringLike").evalStatically());var g=e.requireElement("commandList");e.ensureTerminated(g),e.requireToken("end"),v.listeners.push({type:p,handler:Rn(y,g,v,m)})}return e.requireToken("end"),t!=null&&v.open(t.evalStatically()),m}}};function Cn(s,e,t){var r={listeners:[],retryCount:0,closed:!1,abortController:null,reader:null,lastEventId:null,reconnectTimeout:null,url:null,withCredentials:s,method:e,headers:t,open:function(i){if(i==null)if(r.url!=null)i=r.url;else throw new Error("no url defined for EventSource.");r.url===i&&r.abortController&&!r.abortController.signal.aborted||(r.abortController&&r.abortController.abort(),r.closed=!1,r.url=i,Gi(r))},close:function(){r.closed=!0,r.reconnectTimeout&&(clearTimeout(r.reconnectTimeout),r.reconnectTimeout=null),r.abortController&&(r.abortController.abort(),r.abortController=null),r.retryCount=0,re(r,"close",{type:"close"})},addEventListener:function(i,n,o){r.listeners.push({type:i,handler:n,options:o})}};return r}function Gi(s){var e=new AbortController;s.abortController=e;var t={method:s.method,signal:e.signal,headers:Object.assign({},s.headers||{})};s.withCredentials&&(t.credentials="include"),s.lastEventId&&(t.headers["Last-Event-ID"]=s.lastEventId),fetch(s.url,t).then(function(r){if(!e.signal.aborted){if(!r.ok)throw new Error("SSE connection failed with status "+r.status);return s.retryCount=0,re(s,"open",{type:"open"}),Fn(s,r.body.getReader(),e)}}).catch(function(r){e.signal.aborted||(re(s,"error",{type:"error",error:r}),$i(s))})}async function Fn(s,e,t){s.reader=e;var r=500;try{for await(var i of zi(e)){if(t.signal.aborted)break;i.id&&(s.lastEventId=i.id),i.retry!=null&&(r=i.retry);var n=i.event||"message",o={type:n,data:i.data,lastEventId:i.id||s.lastEventId||""};re(s,n,o)}}catch(a){t.signal.aborted||re(s,"error",{type:"error",error:a})}s.reader=null,!s.closed&&!t.signal.aborted&&$i(s,r)}function $i(s,e){if(!s.closed){e=e||500,s.retryCount=Math.min(7,s.retryCount+1);var t=Math.random()*2**s.retryCount*e;s.reconnectTimeout=setTimeout(function(){s.reconnectTimeout=null,s.closed||Gi(s)},t)}}function re(s,e,t){for(var r=0;r<s.listeners.length;r++){var i=s.listeners[r];if(Mn(i.type,e))try{i.handler(t)}catch(n){console.error("Error in SSE handler for '"+i.type+"':",n)}}}function Rn(s,e,t,r){return function(i){var n=_n(i.data,s),o=r.runtime.makeContext(t,r,t);o.event=i,o.result=n,e.execute(o)}}function _n(s,e){return e.toLowerCase()==="json"?JSON.parse(s):s}function Pn(s,e,t){var r=t.me,i=s.body.getReader(),n=[],o=null,a=!1;(async function(){try{for await(var u of zi(i)){var c=u.event||"message";u.event?e.triggerEvent(r,c,{data:u.data,lastEventId:u.id||""}):(n.push(u.data),o&&(o.resolve({value:u.data,done:!1}),o=null))}}catch(h){e.triggerEvent(r,"stream-error",{error:h})}a=!0,o&&(o.resolve({value:void 0,done:!0}),o=null),e.triggerEvent(r,"streamEnd",{})})();var l={element:r,[Symbol.asyncIterator]:function(){var u=0;return{next:function(){return u<n.length?Promise.resolve({value:n[u++],done:!1}):a?Promise.resolve({value:void 0,done:!0}):new Promise(function(c){o={resolve:c}}).then(function(c){return c.done||u++,c})}}}};return l}var Yi=function(s,e,t){return Pn(s,e,t)};Yi._rawResponse=!0;function Qi(s){s.addFeature(te.keyword,te.parse.bind(te)),s.config.conversions.Stream=Yi}typeof self<"u"&&self._hyperscript&&self._hyperscript.use(Qi);function Ki(s){s.config.hideShowStrategies={twDisplay:function(e,t,r){e==="toggle"?t.classList.contains("hidden")?s.config.hideShowStrategies.twDisplay("show",t,r):s.config.hideShowStrategies.twDisplay("hide",t,r):e==="hide"?t.classList.add("hidden"):t.classList.remove("hidden")},twVisibility:function(e,t,r){e==="toggle"?t.classList.contains("invisible")?s.config.hideShowStrategies.twVisibility("show",t,r):s.config.hideShowStrategies.twVisibility("hide",t,r):e==="hide"?t.classList.add("invisible"):t.classList.remove("invisible")},twOpacity:function(e,t,r){e==="toggle"?t.classList.contains("opacity-0")?s.config.hideShowStrategies.twOpacity("show",t,r):s.config.hideShowStrategies.twOpacity("hide",t,r):e==="hide"?t.classList.add("opacity-0"):t.classList.remove("opacity-0")}}}typeof self<"u"&&self._hyperscript&&self._hyperscript.use(Ki);})();
