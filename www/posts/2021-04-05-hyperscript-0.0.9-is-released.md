...
- **BREAKING CHANGE**: The [eventsource feature](/features/eventsource) now uses the syntax `eventsource <name> [from <url>]` so that URLs can be optionally omitted from the EventSource definition.
