...
The `speak` command uses the [Web Speech API](https://developer.mozilla.org/en-US/docs/Web/API/SpeechSynthesis) to speak text aloud - a nod to [HyperTalk](https://hypercard.org/HyperTalk%20Reference%202.4.pdf).
