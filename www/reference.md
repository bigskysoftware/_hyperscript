...
| name                                     | description                                                           | example                             |
|------------------------------------------|-----------------------------------------------------------------------|-------------------------------------|
| **[components](/features/components)**   | Reusable custom elements with reactive templates                      | `<script type="text/hyperscript-template" component="my-card">`    |
...
| **[cookies](/expressions/cookies)** | A natural API for accessing cookies                   | `cookies['My-Cookie']`                           |
| **clipboard**                       | System clipboard (read & write)                       | `put clipboard into me`, `set clipboard to "hi"` |
