...
```html
<script src="https://cdn.jsdelivr.net/npm/hyperscript.org@0.9.92/dist/_hyperscript.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/hyperscript.org@0.9.92/dist/ext/component.min.js"></script>
```
