...
So, what does this all mean?  Well, when the button is clicked hyperscript will add the `.aClass` to `#anotherDiv`.
...
With that basic introduction, let's look at the broader language.
