...
<div class="hdb" _="
	...
	* {
	...
	`;r.prototype.ui=function(){var t=document.createElement("div"),e=t.attachShadow({mode:"open"});t.style.cssText="all: initial",e.innerHTML=b,document.body.appendChild(t),this._hyperscript.process(e.querySelector(".hdb"))};function h(t){t.addCommand(s.keyword,s.parse.bind(s))}typeof self!="undefined"&&self._hyperscript&&self._hyperscript.use(h);export{h as default};
