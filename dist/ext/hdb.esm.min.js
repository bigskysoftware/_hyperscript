var d=class{sourceFor(){return this.programSource.substring(this.startToken.start,this.endToken.end)}lineFor(){return this.programSource.split(`
`)[this.startToken.line-1]}static parseEventArgs(t){var o=[];if(t.token(0).value==="("&&(t.token(1).value===")"||t.token(2).value===","||t.token(2).value===")")){t.matchOpToken("(");do o.push(t.requireTokenType("IDENTIFIER"));while(t.matchOpToken(","));t.requireOpToken(")")}return o}};var a=class extends d{constructor(){super(),this.constructor.keyword&&(this.type=this.constructor.keyword+"Command")}execute(t){return t.meta.command=this,t.meta.runtime.unifiedExec(this,t)}};var s=class e extends a{static keyword="breakpoint";static parse(t){if(t.matchToken("breakpoint"))return new e}resolve(t){var o;globalThis.hdb=o=new r(t,t.meta.runtime,this);try{return o.break(t)}catch(n){console.error(n,n.stack)}}};function r(e,t,o){this.ctx=e,this.runtime=t,this.cmd=o,this._hyperscript=self._hyperscript,this.cmdMap=[],this.bus=new EventTarget}r.prototype.break=function(e){return console.log("=== HDB///_hyperscript/debugger ==="),this.ui(),new Promise((t,o)=>{this.bus.addEventListener("continue",()=>{if(this.ctx!==e){for(var n in e)delete e[n];Object.assign(e,this.ctx)}delete globalThis.hdb,t(this.runtime.findNext(this.cmd,this.ctx))},{once:!0})})};r.prototype.continueExec=function(){this.bus.dispatchEvent(new Event("continue"))};r.prototype.stepOver=function(){if(!this.cmd)return this.continueExec();var e=this.cmd&&this.cmd.type==="breakpointCommand"?this.runtime.findNext(this.cmd,this.ctx):this.runtime.unifiedEval(this.cmd,this.ctx);if(e.type==="implicitReturn")return this.stepOut();if(e&&e.then instanceof Function)return e.then(t=>{this.cmd=t,this.bus.dispatchEvent(new Event("step")),this.logCommand()});e.halt_flag?this.bus.dispatchEvent(new Event("continue")):(this.cmd=e,this.bus.dispatchEvent(new Event("step")),this.logCommand())};r.prototype.stepOut=function(){if(!this.ctx.meta.caller)return this.continueExec();var e=this.ctx.meta.callingCommand,t=this.ctx.me;this.ctx=this.ctx.meta.caller,console.log("[hdb] stepping out into "+this.ctx.meta.feature.displayName),this.ctx.me instanceof Element&&this.ctx.me!==t&&console.log("[hdb] me: ",this.ctx.me),this.cmd=this.runtime.findNext(e,this.ctx),this.cmd=this.runtime.findNext(this.cmd,this.ctx),this.logCommand(),this.bus.dispatchEvent(new Event("step"))};r.prototype.skipTo=function(e){this.cmd=e.cmd,this.bus.dispatchEvent(new Event("skip"))};r.prototype.rewrite=function(e,t){console.log("##",e);let o=e.cmd.parent,n;for(n of o.children)if(n.next===e.cmd)break;let c=e.next,u=this._hyperscript.internals.tokenizer.tokenize(t),i=this._hyperscript.internals.createParser(u).requireElement("command");console.log(i),i.startToken=e.startToken,i.endToken=e.endToken,i.programSource=e.programSource,i.sourceFor=function(){return t},n.next=i,i.next=c,i.parent=o,this.bus.dispatchEvent(new Event("step"))};r.prototype.logCommand=function(){var e=this.cmd.sourceFor instanceof Function,t=e?this.cmd.sourceFor():"-- "+this.cmd.type;console.log("[hdb] current command: "+t)};r.prototype.traverse=function(e){let t=[];return(function o(n){if(t.push(n),"children"in n)for(let c of n.children)o(c)})(e),t};var p=`
<div class="hdb" _="
	...
	* {
	...
	`;r.prototype.ui=function(){var e=document.createElement("div"),t=e.attachShadow({mode:"open"});e.style.cssText="all: initial",t.innerHTML=p,document.body.appendChild(e),this._hyperscript.process(t.querySelector(".hdb"))};function l(e){e.addCommand(s.keyword,s.parse.bind(s))}typeof self<"u"&&self._hyperscript&&self._hyperscript.use(l);export{l as default};
