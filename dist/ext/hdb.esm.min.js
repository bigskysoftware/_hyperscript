var m=Object.defineProperty;var f=(t,e,o)=>e in t?m(t,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):t[e]=o;var l=(t,e,o)=>f(t,typeof e!="symbol"?e+"":e,o);var u=class{sourceFor(){return this.programSource.substring(this.startToken.start,this.endToken.end)}lineFor(){return this.programSource.split(`
`)[this.startToken.line-1]}static parseEventArgs(e){var o=[];if(e.token(0).value==="("&&(e.token(1).value===")"||e.token(2).value===","||e.token(2).value===")")){e.matchOpToken("(");do o.push(e.requireTokenType("IDENTIFIER"));while(e.matchOpToken(","));e.requireOpToken(")")}return o}};var a=class extends u{constructor(){super(),this.constructor.keyword&&(this.type=this.constructor.keyword+"Command")}execute(e){return e.meta.command=this,e.meta.runtime.unifiedExec(this,e)}static parsePseudopossessiveTarget(e){var o;if(e.matchToken("the")||e.matchToken("element")||e.matchToken("elements")||e.currentToken().type==="CLASS_REF"||e.currentToken().type==="ID_REF"||e.currentToken().op&&e.currentToken().value==="<"){e.possessivesDisabled=!0;try{o=e.parseElement("expression")}finally{e.possessivesDisabled=!1}e.matchOpToken("'")&&e.requireToken("s")}else e.currentToken().type==="IDENTIFIER"&&e.currentToken().value==="its"?o=e.parseElement("pseudopossessiveIts"):(e.matchToken("my")||e.matchToken("me"),o=e.parseElement("implicitMeTarget"));return o}};var c=class c extends a{static parse(e){if(e.matchToken("breakpoint"))return new c}resolve(e){var o;globalThis.hdb=o=new i(e,e.meta.runtime,this);try{return o.break(e)}catch(n){console.error(n,n.stack)}}};l(c,"keyword","breakpoint");var s=c;function i(t,e,o){this.ctx=t,this.runtime=e,this.cmd=o,this._hyperscript=self._hyperscript,this.cmdMap=[],this.bus=new EventTarget}i.prototype.break=function(t){return console.log("=== HDB///_hyperscript/debugger ==="),this.ui(),new Promise((e,o)=>{this.bus.addEventListener("continue",()=>{if(this.ctx!==t){for(var n in t)delete t[n];Object.assign(t,this.ctx)}delete globalThis.hdb,e(this.runtime.findNext(this.cmd,this.ctx))},{once:!0})})};i.prototype.continueExec=function(){this.bus.dispatchEvent(new Event("continue"))};i.prototype.stepOver=function(){if(!this.cmd)return this.continueExec();var t=this.cmd&&this.cmd.type==="breakpointCommand"?this.runtime.findNext(this.cmd,this.ctx):this.runtime.unifiedEval(this.cmd,this.ctx);if(t.type==="implicitReturn")return this.stepOut();if(t&&t.then instanceof Function)return t.then(e=>{this.cmd=e,this.bus.dispatchEvent(new Event("step")),this.logCommand()});t.halt_flag?this.bus.dispatchEvent(new Event("continue")):(this.cmd=t,this.bus.dispatchEvent(new Event("step")),this.logCommand())};i.prototype.stepOut=function(){if(!this.ctx.meta.caller)return this.continueExec();var t=this.ctx.meta.callingCommand,e=this.ctx.me;this.ctx=this.ctx.meta.caller,console.log("[hdb] stepping out into "+this.ctx.meta.feature.displayName),this.ctx.me instanceof Element&&this.ctx.me!==e&&console.log("[hdb] me: ",this.ctx.me),this.cmd=this.runtime.findNext(t,this.ctx),this.cmd=this.runtime.findNext(this.cmd,this.ctx),this.logCommand(),this.bus.dispatchEvent(new Event("step"))};i.prototype.skipTo=function(t){this.cmd=t.cmd,this.bus.dispatchEvent(new Event("skip"))};i.prototype.rewrite=function(t,e){console.log("##",t);let o=t.cmd.parent,n;for(n of o.children)if(n.next===t.cmd)break;let d=t.next,p=this._hyperscript.internals.tokenizer.tokenize(e),r=this._hyperscript.internals.createParser(p).requireElement("command");console.log(r),r.startToken=t.startToken,r.endToken=t.endToken,r.programSource=t.programSource,r.sourceFor=function(){return e},n.next=r,r.next=d,r.parent=o,this.bus.dispatchEvent(new Event("step"))};i.prototype.logCommand=function(){var t=this.cmd.sourceFor instanceof Function,e=t?this.cmd.sourceFor():"-- "+this.cmd.type;console.log("[hdb] current command: "+e)};i.prototype.traverse=function(t){let e=[];return(function o(n){if(e.push(n),"children"in n)for(let d of n.children)o(d)})(t),e};var b=`
<div class="hdb" _="
	...
	* {
	...
	`;i.prototype.ui=function(){var t=document.createElement("div"),e=t.attachShadow({mode:"open"});t.style.cssText="all: initial",e.innerHTML=b,document.body.appendChild(t),this._hyperscript.process(e.querySelector(".hdb"))};function h(t){t.addCommand(s.keyword,s.parse.bind(s))}typeof self!="undefined"&&self._hyperscript&&self._hyperscript.use(h);export{h as default};
