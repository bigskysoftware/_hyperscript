"use strict";(()=>{var Fi=Object.defineProperty;var x=(s,e)=>{for(var t in e)Fi(s,t,{get:e[t],enumerable:!0})};var pe=class{#t;#i=[];#s=null;#o=[];source;constructor(e,t){this.#t=e,this.source=t,this.consumeWhitespace()}get list(){return this.#t}get consumed(){return this.#i}toString(){var e=this.currentToken(),t=this.source.split(`
