  ...
  function createPanel(_hyperscript2, ttd, timeline, domRestorer, recorder) {
    ...
    function renderTimelineTrack() {
      ...
      for (var step of steps) {
        ...
        tick.innerHTML = '<span class="d-tl-tick-idx">#' + step.index + '</span><span class="d-tl-tick-src">' + esc(src) + "</span>";
    ...
    function selectElement(el) {
      ...
      content.innerHTML = '<div class="d-label">Element</div><div class="d-code">&lt;' + t + id + c + '&gt;</div><div class="d-dbg-toolbar"><span class="d-label">Hyperscript</span></div><div class="d-code-area"><div class="d-editor"></div></div>';
