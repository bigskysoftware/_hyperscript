var Fi=Object.defineProperty;var x=(s,e)=>{for(var t in e)Fi(s,t,{get:e[t],enumerable:!0})};var pe=class{#t;#i=[];#s=null;#o=[];source;constructor(e,t){this.#t=e,this.source=t,this.consumeWhitespace()}get list(){return this.#t}get consumed(){return this.#i}toString(){var e=this.currentToken(),t=this.source.split(`
...
`;else if(i==="r")r+="\r";else if(i==="t")r+="	";else if(i==="v")r+="\v";else if(e.template&&i==="$")r+="\\$";else if(i==="x"){let n=this.#W();if(Number.isNaN(n))throw new Error("Invalid hexadecimal escape at [Line: "+e.line+", Column: "+e.column+"]");r+=String.fromCharCode(n)}else r+=i}else r+=this.#r();if(this.#e()!==t)throw new Error("Unterminated string at [Line: "+e.line+", Column: "+e.column+"]");return this.#r(),e.value=r,e.end=this.#i,e}#W(){if(!this.#e())return NaN;let e=16*Number.parseInt(this.#r(),16);return this.#e()?(e+=Number.parseInt(this.#r(),16),e):NaN}#j(){var e=this.#e(),t=this.#f(),r=this.#b(2);return e==="-"&&t==="-"&&(this.#v(r)||r===""||r==="-")||e==="/"&&t==="/"&&(this.#v(r)||r===""||r==="/")}#U(){for(;this.#i<this.#t.length;)if(this.#j())this.#I();else if(this.#v(this.#e()))this.#n.push(this.#L());else if(!this.#g()&&this.#e()==="."&&(this.#l(this.#f())||this.#f()==="{"||this.#f()==="-"))this.#n.push(this.#O());else if(!this.#g()&&this.#e()==="#"&&(this.#l(this.#f())||this.#f()==="{"))this.#p==="lines"&&this.#c==="indeterminant"?(this.#c="command",this.#n.push(this.#P())):this.#n.push(this.#M());else if(this.#p==="lines"&&this.#c==="indeterminant"&&this.#h===0)this.#c="template",this.#n.push(this.#H());else if(this.#e()==="["&&this.#f()==="@")this.#n.push(this.#F());else if(this.#e()==="@")this.#n.push(this.#R());else if(this.#e()==="*"&&this.#l(this.#f()))this.#n.push(this.#C());else if(this.#T()&&(this.#l(this.#e())||this.#e()==="\\")&&this.#c!=="command")this.#n.push(this.#_());else if(this.#k()&&(this.#l(this.#e())||this.#y(this.#e())))this.#n.push(this.#S());else if(this.#u(this.#e()))this.#n.push(this.#D());else if(this.#k()&&(this.#e()==='"'||this.#e()==="`"))this.#n.push(this.#x());else if(this.#k()&&this.#e()==="'")this.#N()?this.#n.push(this.#x()):this.#n.push(this.#q());else if(me[this.#e()])this.#a==="$"&&this.#e()==="{"&&this.#h++,this.#e()==="}"&&this.#h--,this.#n.push(this.#q());else if(this.#T()||this.#w(this.#e()))this.#n.push(this.#m("RESERVED",this.#r()));else if(this.#i<this.#t.length)throw new Error("Unknown token: "+this.#e()+" ");return new pe(this.#n,this.#t)}};var I=class s{errors=[];collectErrors(e){if(e||(e=new Set),e.has(this))return[];e.add(this);var t=[...this.errors];for(var r of Object.keys(this))for(var i of[this[r]].flat())i instanceof s&&t.push(...i.collectErrors(e));return t}sourceFor(){return this.programSource.substring(this.startToken.start,this.endToken.end)}lineFor(){return this.programSource.split(`
...
`),i=new Map;for(var n of e){var o=n.token?.line?n.token.line-1:r.length-1;i.has(o)||i.set(o,[]),i.get(o).push(n)}var a=Math.max(...i.keys())+1,l=String(a).length,u=" ".repeat(l+5),h=[...i.entries()].sort((q,k)=>q[0]-k[0]),f=-1,m="";for(var[o,c]of h){(f!==-1&&o>f+1||f===-1&&o>0)&&(m+=" ".repeat(l+1)+`...
`),f=o;var T=String(o+1).padStart(l),p=r[o]||"";m+="  "+T+" | "+p+`
