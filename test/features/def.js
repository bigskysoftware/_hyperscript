describe("the def feature", function () {
	...
	it("is called synchronously", function () {
		var script = make("<script type='text/hyperscript'>" + "def foo() " + "  log me" + "end" + "</script>");
	...
	it("can return a value synchronously", function () {
		var script = make("<script type='text/hyperscript'>" + "def foo() " + '  return "foo"' + "end" + "</script>");
	...
	it("can exit", function () {
		make("<script type='text/hyperscript'>" + "def foo() " + "  exit " + "end" + "</script>");
